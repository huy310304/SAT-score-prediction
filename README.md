...
- **Hyperparameter Tuning and Model Design:** Conducted 100+ hyperparameter fine-tuning and different neural network models, loss function, optimizer, and learning rate scheduler to optimize the model's performance and achieve an accuracy of 90% (see [sat final regression](regression/sat_regression_final.py)).
