...
- **Hyperparameter Tuning and Model Design:** Conducted 100+ hyperparameter fine-tuning and trying different combinations of neural network models, loss function, optimizer, and learning rate scheduler to optimize model's performance and achieve an accuracy of 90%.
