...
- **Training Process:** The initial model was trained using a dataset in the [original csv file](../data/GPA_Small.csv) that included SAT scores and related input features in `data`, with SAT Score being a primary focus.
